...
export class Favorites {
    constructor(root) {
        ...
        GithubUser.search('leoonardoferreira')
    ...
    delete(user) {
        // funções de alta ordem (em inglês, high order functions). map; filter; find; reduce
...
export class FavoritesView extends Favorites {
    ...
    createRow() {
        ...
        <td colspan="3">
            <div class="user">
                <img src="https://github.com/leoonardoferreira.png" alt="Imagem de Leonardo Ferreira">
                <a href="https://github.com/leoonardoferreira" target="_blank">
                    <p>Leonardo Ferreira</p>
                    <span>/leoonardoferreira</span>
                </a>
            </div>
        </td>
